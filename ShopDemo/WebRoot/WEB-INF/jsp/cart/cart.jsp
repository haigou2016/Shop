		...
		<div class="container cart">
			<div class="span24">
				...
				<table>
					<tbody>
						...
						<tr>
							...
							<td>
								<a href="${pageContext.request.contextPath}/cart_deleteItem.action?pid=<s:property value="#c.product.pid"/>" class="delete">删除</a>
							</td>
						</tr>
						</s:iterator>
					</tbody>
				...
				<div class="total">
					...
					<em id="effectivePoint">596</em> 商品金额:
				...
				<div class="bottom">
					...
					<a href="${pageContext.request.contextPath}/order_submit.action" id="submit"
						class="submit">提交订单</a>
				</div>
				</s:if>
				<s:else>
				   <div class="bottom">
					<a href="#" onclick="return false">提交订单</a>
				</div>
				</s:else>
			</div>
		</div>
