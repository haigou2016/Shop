	...
	<head>
		...
		<link href="${pageContext.request.contextPath}/css/register.css"
			...
			function checkForm(){
			  ...
			  if(rpassword!=null&&password!=rpassword){
			   alert("请输入一致的密码");
			   return  false;
			  }
			  var email=  $("#email").val();
			...
			function checkUsername(){
			 var username=  $("#username").val();
			 var rurl = '${pageContext.request.contextPath}/user_checkUsername.action';
			 $.ajax({  
                type: "post",
			...
			<div class="span24">
				<div class="wrap">
					<div class="main clearfix">
						...
						<form id="registerForm" method="post" action="${pageContext.request.contextPath}/user_registInfo.action" novalidate="novalidate" >
							<table>
								<tbody>
									<tr>
										<th>
									...
									<tr>
										...
										<td>
											<input type="password"  class="text" id="rpassword" name="rpassword"
												maxlength="20" autocomplete="off">
										<s:fielderror fieldName="rpassword"></s:fielderror>
										</td>
									</tr>
									<tr>
										<th>
										...
										<td>
											<div id="agreement" class="agreement" style="height: 200px;">
												...
												<p>
													...
													<br>
													1. 反对宪法所确定的基本原则的； 2. 危害国家安全，泄露国家秘密，颠覆国家政权，破坏国家统一的； 3.
													损害国家荣誉和利益的； 4. 煽动民族仇恨、民族歧视，破坏民族团结的； 5. 破坏国家宗教政策，宣扬邪教和封建迷信的；
													6. 散布谣言，扰乱社会秩序，破坏社会稳定的； 7. 散布淫秽、色情、赌博、暴力、凶杀、恐怖或者教唆犯罪的； 8.
													侮辱或者诽谤他人，侵害他人合法权益的； 9. 含有法律、行政法规禁止的其他内容的。
												</p>
												<p>
													四、有关个人资料
													<br>
													用户同意: 1. 提供及时、详尽及准确的个人资料。 2. 同意接收来自本网站的信息。 3.
