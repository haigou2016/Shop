				...
				<div class="span18 last">
					<div class="productImage">
						<a title="" style="outline-style: none; text-decoration: none;"
							id="zoom"
							href="${pageContext.request.contextPath }/${image}"
							rel="gallery">
							<div class="zoomPad">
					...
					<form action="${pageContext.request.contextPath }/cart_addItem.action" method="post">
