			...
			<div class="span24">
				...
				<table>
					<tbody align="center">
						...
						<tr>
							<td width="60">
								<img src="${ctx }/<s:property value="#orderItem.product.image"/> " />
							</td>
							<td>
								<a target="_blank"><s:property value="#orderItem.product.pname" />
								</a>
							</td>
							<td>
				...
				<div class="total">
					...
					<strong id="effectivePrice">￥<s:property value="model.total" /></strong>
				</div>
				<form id="orderForm" action="${ctx}/order_payOrder.action"
					method="post">
					<input type="hidden" name="order.oid" value="" />
					<div class="span24">
						<p>
							收货地址：
							<input name="order.user.addr" type="text" value="<s:property value="model.addr" />"
								style="width: 350px" />
							<br />
							收货人&nbsp;&nbsp;&nbsp;：
							<input name="order.user.username" type="text" value="<s:property value="model.name" />"
								style="width: 150px" />
							<br />
							联系方式：
							<input name="order.user.phone" type="text" value="<s:property value="model.phone" />"
								style="width: 150px" />
